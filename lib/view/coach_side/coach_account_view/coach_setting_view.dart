...
class CoachSettingView extends StatefulWidget {
  const CoachSettingView({super.key});

  @override
  State<CoachSettingView> createState() => _CoachSettingViewState();
}

class _CoachSettingViewState extends State<CoachSettingView> {
            ...
            children: [
              _size.heightSpace(10),
               Container(
                ...
                child: Column(
                  children: [
                    accountSettingType('setting_filled', 'Setting 1'),
                    accountSettingType('setting_filled', 'Setting 2'),
                    accountSettingType('setting_filled', 'Setting 3')
                  ],
                ),
              ),
              ...
              Container(
                ...
                child: Column(
                  children: [
                    accountSettingType('setting_filled', 'Setting 4'),
                    accountSettingType('setting_filled', 'Setting 5'),
                    accountSettingType('setting_filled', 'Setting 6')
                  ],
                ),
              ),
